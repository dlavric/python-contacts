...
# Create the Contact class with an initializer
...
def add_session_to_contact():
    ...
    if contact!=None:
        ...
        session_length=read_float_ranged(prompt='Session length : ',min_value=0.5,max_value=10)
...
def load_contacts(file_name):
    ...
    '''
    global contacts
    # Printing "Load contacts" to know the agenda has been found
    print('Load contacts')
